...
#use census API from censusapi library to retrive state shapefiles (same regardless of year)
...
#create a list of all state names avaliable for selecti
...
server <- function(input, output) {
    ...
    #use census API from censusapi library to retrive county shapefiles by inputted year
